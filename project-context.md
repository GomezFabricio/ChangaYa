...
**Módulo de Perfiles:** Perfil de cliente (nombre, email, teléfono, localidad, foto). Perfil de prestador (categorías hasta 2/5 según plan, especialidades, zonas hasta 2/5 según plan, descripción, experiencia, tarifas, portfolio hasta 5/15 fotos según plan). Indicador de completitud (%). Guardado automático por campo. Badges Pro y Verificado. Toggle de visibilidad en búsquedas.
...
Modelo híbrido: suscripción freemium para prestadores + comisión sobre trabajos completados (Fase 2+). Clientes no pagan cuota de suscripción.

**Fase 1 (MVP):** Solo suscripción. La comisión requiere integración de pagos entre partes (no disponible en v1 donde los pagos son externos — efectivo/transferencia).

**Fase 2+:** Introducir comisión del 5-8% sobre el valor declarado de trabajos completados, procesada via Mercado Pago. Esto desacopla el revenue de la conversión de plan y lo escala con el volumen de transacciones. La desintermediación es un riesgo real en servicios presenciales; la comisión solo aplica a trabajos gestionados íntegramente por la plataforma (coordinar pagos fuera de la app rompe términos de servicio).

**Fundamentación:** El benchmark de conversión freemium es 0.5-2%. Con 100 prestadores y 2% real = 2 pagando. El modelo de solo suscripción es insuficiente para sostener operaciones a esa escala. La comisión sobre transacciones escala linealmente con el volumen y es el modelo de monetización estándar en marketplaces de servicios (Fiverr, TaskRabbit, GetOnBoard).

### F.2 Planes

**ChangaYa Básico (gratuito):** Perfil público, búsquedas, solicitudes, mensajería, reseñas. Portfolio hasta 5 fotos, hasta 2 categorías, hasta 2 zonas, hasta 5 solicitudes activas, estadística básica.

**ChangaYa Pro (pago):** Todo lo básico + portfolio 15 fotos, 5 categorías, 5 zonas, solicitudes ilimitadas, badge Pro, boost 15% en búsqueda, estadísticas ampliadas, perfil destacado en home, soporte prioritario.

**Precio:** Basic ARS $2.500/mes, Pro ARS $5.000/mes. Mensual sin compromiso. Trial 30 días gratis (una vez, solo plan Pro). Medio: Mercado Pago.
...
**Fase 2 (meses 4-6):** Pro con trial. Verificación de identidad. Meta: 2-3% conversión a Pro (benchmark freemium realista). Introducir comisión 5-8% en trabajos completados via Mercado Pago.
**Fase 3 (meses 7-12):** Ajuste de precios, boost individual, plan anual (20% off). Meta: 3-5% conversión + comisión cubriendo costos operativos.
